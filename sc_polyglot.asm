...
;
;+------------------------------------------------------------------------------+
;|::::::::::| a boring x86 shellcode which is also a boring NES ROM  |::::::::::|
;+------------------------------------------------------------------------------+
;
; by s01den
;
...
header: ; a valid NES header
  ...
  nop
code:
  db `\x76\x11` ;those bytes mean jbe valid_x86_code in x86 and ror 1,X in nes 6502   <--- idea from http://phrack.org/issues/57/14.html#article (/* magic string */)
  valid_nes_code:
...
; the full shellcode (39 bytes) --> \x4e\x45\x53\x1a\xc0\x73\x0a\x00\x00\x00\x00\x00\x00\x00\x00\x00\x90\x76\x11\xa9\x01\x8d\x01\x02\xa9\x05\x8d\x02\x02\xa9\x08\x8d\x03\x02\xd0\xef\x40\xcd\x80
